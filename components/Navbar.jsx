            ...
            {NAV_LINKS.map((link) => (
              <li key={link.id} className="w-full">
                <a
                  ...
                  className="block py-2 px-3 text-gray-800 text-lg font-semibold rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 whitespace-nowrap"
                >
                  {link.title}
                </a>
              </li>
